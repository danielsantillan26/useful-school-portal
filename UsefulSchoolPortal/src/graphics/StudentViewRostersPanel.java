...
/**
 * The StudentViewRostersPanel class contains the graphics necessary to view
 * the rosters for each class the student is in.
 * 
...
public class StudentViewRostersPanel extends JPanel {
	...
	public String toString() {
		return "StudentViewRostersPanel [classList=" + classList + ", classes=" + classes + ", classID=" + classID
