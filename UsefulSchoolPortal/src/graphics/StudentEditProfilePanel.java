...
/**
 * The StudentEditProfilePanel class contains the graphics necessary to edit
 * their own profile in the school system. In this panel, students have text
...
public class StudentEditProfilePanel extends JPanel {
	...
	public String toString() {
		return "StudentEditProfilePanel [isPasswordShown=" + isPasswordShown + "]";
	}
}
