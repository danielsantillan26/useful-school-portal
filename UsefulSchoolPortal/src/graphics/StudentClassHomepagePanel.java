...
/**
 * The StudentClassHomepagePanel class contains the graphics necessary to view a
 * class homepage. In this panel, students can view the classes they are in and
 * see the homework pages their teacher provides.
 * 
 * @author Daniel Santillan
 * @version 1.0
 */
public class StudentClassHomepagePanel extends JPanel {
	 ...
	 */
	public StudentClassHomepagePanel() {
	...
	public String toString() {
		return "StudentClassHomepagePanel [classList=" + classList + ", classes=" + classes + ", announcement="
